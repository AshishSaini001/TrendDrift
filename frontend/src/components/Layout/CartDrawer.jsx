...
const CartDrawer = ({drawerOpen,toggleCartDrawer}) => {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 w-[88vw] sm:w-lg md:w-136 lg:w-120 xl:w-md max-w-[92vw] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 
        ...
        {/* Checkout Button */}
        <div className='p-3 sm:p-4 bg-white sticky bottom-0 '>
